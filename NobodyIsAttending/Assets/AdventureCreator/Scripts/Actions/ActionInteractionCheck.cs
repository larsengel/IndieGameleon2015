	...
	public class ActionInteractionCheck : ActionCheck
	{
		...
		override public bool CheckCondition ()
		{
			...
			if (interactionType == InteractionType.Use)
			{
				...
				{
					Debug.LogWarning ("Cannot check Hotspot " + hotspot.gameObject.name + "'s Use button " + number.ToString () + " because it doesn't exist!");
				}
			}
			...
			else if (interactionType == InteractionType.Inventory)
			{
				...
				{
					Debug.LogWarning ("Cannot check Hotspot " + hotspot.gameObject.name + "'s Inventory button " + number.ToString () + " because it doesn't exist!");
				}
			}
