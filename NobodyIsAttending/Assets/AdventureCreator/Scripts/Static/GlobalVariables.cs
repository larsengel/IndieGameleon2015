...
namespace AC
{
	...
	public class GlobalVariables : MonoBehaviour
	{
		...
		public static int GetIntegerValue (int _id, bool synchronise = true)
		{
			...
			Debug.LogWarning ("Variable with ID=" + _id + " not found!");
			return 0;
		}
		 ...
		 */
		public static string GetStringValue (int _id, bool synchronise = true)
		{
			GVar var = GetVariable (_id);
			if (var != null)
			{
		 ...
		 * <returns>The string value of the variable</returns>
		 */
		public static string GetPopupValue (int _id, bool synchronise = true)
		{
			GVar var = GetVariable (_id);
			if (var != null)
			{
