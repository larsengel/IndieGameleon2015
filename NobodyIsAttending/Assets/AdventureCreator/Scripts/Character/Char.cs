		...
		protected void PathUpdate ()
		{
			if (activePath && activePath.nodes.Count > 0)
			{
				...
				else
				{
					...
					{
						nodeThreshold = 1.1f - KickStarter.settingsManager.destinationAccuracy;
					}
...
//			}
		...
		private bool AccurateDestination ()
		{
		...
		public void SetExpression (int ID)
		{
			...
			Debug.LogWarning ("Cannot find expression with ID=" + ID.ToString () + " on character " + gameObject.name);
		}
