...
namespace AC
{
	...
	public class MainCamera : MonoBehaviour
	{
		...
		private void Awake ()
		{
			...
			{
				Debug.LogWarning ("Note: The MainCamera is parented to an unknown object. Be careful when moving the parent, as it may cause mis-alignment when the MainCamera is attached to a GameCamera.");
			}
